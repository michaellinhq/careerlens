/**
 * Real transition stories — social proof from manufacturing career changers.
 * These are based on real patterns observed in the automotive/manufacturing industry.
 */
